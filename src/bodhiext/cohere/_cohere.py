"""Bodhilib Cohere Plugin LLM Service module."""
...
class Cohere(BaseLLM):
    """Bodhilib Cohere Plugin LLM Service implementation."""
...
def bodhilib_list_services() -> List[Service]:
    ...
    return [
        Service(
            ...
            service_builder=bodhiext_cohere_llm_service_builder,
            version=__version__,
        )
    ]


def bodhiext_cohere_llm_service_builder(
    *,
    ...
    **kwargs: Dict[str, Any],
    ...
    """LLM service builder for Bodhilib Cohere Plugin.

    Returns:
        Cohere: Bodhilib LLM service implementation for Bodhilib Cohere Plugin
    """
